...
QtObject {
    ...
    readonly property int offset1: 24
    readonly property int offset2: 16
    readonly property int offset3: 8
    readonly property int offset4: 4
    readonly property int offset5: 2

    // Text
    readonly property string fontFamily: "JetBrainsMono Nerd Font Propo"
    
    readonly property int fontSize1: 30
